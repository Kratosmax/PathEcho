...
| 包 | 适用场景 |
|---|---|
| `PathEcho-0.2.2-Full-Setup.exe` | 推荐，自带 .NET 8 运行时并提供卸载程序 |
| `PathEcho-0.2.2-Lite-Setup.exe` | 安装版，需要 [.NET 8 Desktop Runtime x64](https://dotnet.microsoft.com/download/dotnet/8.0) |
| `PathEcho-0.2.2-Full.zip` | 免安装，自带 .NET 8 运行时 |
| `PathEcho-0.2.2-Lite.zip` | 最小免安装包，需要 .NET 8 Desktop Runtime x64 |
